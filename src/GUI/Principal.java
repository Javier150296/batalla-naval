...
public class Principal extends JFrame {
	...
	public Principal(int rows, int cols, Game g) {
		game = g;
		
		gridGUI = new GridGUI(rows, cols, game, true, this);
		gridGUI2 = new GridGUI(rows, cols, game, false, this);
		gridGUI.setBorder(new TitledBorder("Tu tablero"));
		gridGUI2.setBorder(new TitledBorder("El adversario"));		
		
		
		opponentPanel = new JPanel();
		opponentPanel.setBorder(new TitledBorder("Adversario"));
		opponentPanel.add(addressfield = new JTextField("Direccion IP"));
		opponentPanel.add(createButton = new JButton("Crear conexión"));
		...
		opponentPanel.add(connectButton = new JButton("Conectar"));
		...
		opponentPanel.add(aiButton = new JButton("vs PC"));
		...
		flottaGUI.setBorder(new TitledBorder("Flota"));
		
		setLayout(new FlowLayout());
		
		shipButtons = new JButton[5];
		shipButtons[0] = aircraftCarrierButton = new JButton("Portaaviones");
		shipButtons[1] = battleshipButton = new JButton("Buque de guerra");
		shipButtons[2] = destroyerButton = new JButton("Destructor");
		shipButtons[3] = submarineButton = new JButton("Submarino");
		shipButtons[4] = patrolBoatButton = new JButton("Bote Patrullero");
